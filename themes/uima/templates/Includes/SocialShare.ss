	<ul class="dailyart__social clearfix">
		...
		<li>
			<a class="" target="_blank" href="https://pinterest.com/pin/create/button/?url=$AbsoluteLink&media=$DailyArtImage.SetRatioSize(500,500).URL&description=$Title" data-pin-do="buttonPin" data-pin-config="none"><img src="{$ThemeDir}/images/pinterest-circle.png" alt="pin on pinterest"></a>
		</li>
		<li>

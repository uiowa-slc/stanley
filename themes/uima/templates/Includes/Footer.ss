		...
		<div class="container">
			<div class="footer-contact">
				<div itemscope itemtype="http://schema.org/Organization">
					...
					<p><small>&copy; {$Now.Year} $SiteConfig.Title<br />All Rights Reserved. <a href="http://www.uiowa.edu/homepage/online-privacy-information">Privacy Policy</a></small></p>
					$SiteConfig.Address
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="clearfix footer-logos">
				...
				<a href="http://uima.uiowa.edu">
					<img src="{$ThemeDir}/images/iowamuseum_logo.png" alt="Stanley Museum of Art">
				</a>
			</div>
